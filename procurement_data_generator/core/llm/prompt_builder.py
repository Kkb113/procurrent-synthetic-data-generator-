...
def _v2_status_realism_section() -> str:
    return "\n".join(
        [
            ...
            "- PurchaseOrderHdr.POStatus: Received only.",
            "- PurchaseOrderLine.LineStatus: Received only.",
            "- POSchedule.ScheduleStatus: Shipped for completed full-received schedules.",
            "- ShipmentHdr.ShipmentStatus: Delivered for completed full-received shipments.",
            "- GoodsReceiptHeader.ReceiptStatus: Received for full receipts with ShortQuantity = 0 and DamagedQuantity = 0.",
            "- IncomingInspection.InspectionStatus: Passed for the current fully accepted inspection flow.",
            "- InspectionResult.ResultStatus: Passed with RejectedQuantity = 0.",

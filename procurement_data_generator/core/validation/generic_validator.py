"""Generic generated DataFrame validation.

This module owns metadata-level checks only: table/column existence, PK/FK
integrity, allowed values, ranges, nullability, and simple value hygiene.
Module lifecycle and business rules live under their module packages.
"""
...
class GenericGeneratedDataValidator:
    """Validate generated DataFrames against metadata-level constraints."""
        ...
        for column_name in dataframe.columns:
            ...
            if not passed:
                report.add_issue(
                    ...
                    "Generate non-negative quantity values.",
                    table_name=table.table_name,
                    column_name=column_name,
                    sample_failed_rows=self._sample_rows(dataframe[mask.fillna(False)]),
                )
